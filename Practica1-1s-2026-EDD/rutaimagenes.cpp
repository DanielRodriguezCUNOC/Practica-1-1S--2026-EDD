...
// 🔹 MODO SEGÚN TIPO DE CARTA (UNO FLIP REAL)
std::string RutaImagenes::modoDeJuego(TipoCarta tipo){
    switch(tipo){
    // Lado oscuro (FLIP)
    case TipoCarta::ROBA1:
    case TipoCarta::ROBA3:
    case TipoCarta::SALTODOS:
    case TipoCarta::CAMBIARDIRECCION:
    case TipoCarta::FLIP:
